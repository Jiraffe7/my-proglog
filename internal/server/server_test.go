...
import (
	...
	"github.com/Jiraffe7/proglog/internal/auth"
	"github.com/Jiraffe7/proglog/internal/config"
	"github.com/Jiraffe7/proglog/internal/log"
...
func TestMain(m *testing.M) {
	...
	// using the preferred method of env var for feature toggle
	// sadly there's no utility functions on testing.M
	// to log and make this option known
...
func setupTest(t *testing.T, fn func(*Config)) (rootClient, nobodyClient api.LogClient, cfg *Config, teardown func()) {
	...
	// client = api.NewLogClient(cc) // TLS
